...
static function bool AllowedFor(class<Weapon> Weapon, Pawn Other)
{
	...
	if ( ClassIsChildOf(Weapon, class'SniperRifle') || ClassIsChildOf(Weapon, class'ONSAVRiL') || ClassIsChildOf(Weapon, class'ShockRifle') || ClassIsChildOf(Weapon, class'ClassicSniperRifle') || ClassIsChildOf(Weapon, Class'CryoarithmeticEqualizer'))
		return true;
	...
	if(instr(caps(string(Weapon)), "EQUALIZER") > -1)
		return true;

	if(instr(caps(string(Weapon)), "RAIL GUN") > -1)
		return true;
		
	if(instr(caps(string(Weapon)), "BIO") > -1)
		return true;		
