...
function Activate()
{
	     ...
	     && VSize(HitPawn.Location - StartTrace) < MaxRange && HitPawn.Controller.bGodMode == False)
	{
		...
		if (Inv == None)
		{
			...
			Inv.GiveTo(HitPawn);
			Instigator.PlaySound(Sound'DEKRPG208AJ.TurretSounds.SolarTurretAltCharge', SLOT_None, Instigator.TransientSoundVolume*1.75);
...
defaultproperties
{
     ...
     IconMaterial=Texture'DEKRPGTexturesMaster208K.Artifacts.Immobilize'
     ItemName="Immobilize"
}
