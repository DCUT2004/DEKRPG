...
defaultproperties
{
	...
	ExcludingAbilities(3)=Class'DEKRPG209B.AbilityComboBuffWard'
	...
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers'),RequiredMaterialLevels=(25,25,10,10))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers'),RequiredMaterialLevels=(30,30,20,20))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers'),RequiredMaterialLevels=(35,35,30,30))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers',Class'DEKRPG209B.AbilityMaterialDust'),RequiredMaterialLevels=(40,40,40,40,10))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers',Class'DEKRPG209B.AbilityMaterialDust'),RequiredMaterialLevels=(45,45,45,45,25))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialLumber',Class'DEKRPG209B.AbilityMaterialTarydiumShards',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers',Class'DEKRPG209B.AbilityMaterialDust'),RequiredMaterialLevels=(50,50,50,50,50))
}