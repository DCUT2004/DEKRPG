...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AF.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AF.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AF.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AF.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AF.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AF.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AF.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AF.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AF.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AF.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AF.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AF.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AF.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AF.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AF.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AF.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AF.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AF.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AF.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AF.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AF.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AF.ArtifactSphereDamage'
