...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG209F.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG209F.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG209F.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG209F.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG209F.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG209F.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG209F.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG209F.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG209F.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG209F.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG209F.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG209F.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG209F.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG209F.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG209F.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG209F.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG209F.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG209F.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG209F.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG209F.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG209F.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG209F.ArtifactSphereDamage'
