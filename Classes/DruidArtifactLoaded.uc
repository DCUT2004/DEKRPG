...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG209B.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG209B.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG209B.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG209B.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG209B.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG209B.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG209B.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG209B.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG209B.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG209B.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG209B.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG209B.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG209B.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG209B.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG209B.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG209B.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG209B.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG209B.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG209B.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG209B.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG209B.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG209B.ArtifactSphereDamage'
