...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AH.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AH.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AH.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AH.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AH.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AH.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AH.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AH.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AH.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AH.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AH.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AH.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AH.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AH.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AH.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AH.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AH.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AH.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AH.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AH.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AH.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AH.ArtifactSphereDamage'
