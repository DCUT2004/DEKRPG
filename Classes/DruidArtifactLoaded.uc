...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AA.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AA.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AA.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AA.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AA.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AA.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AA.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AA.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AA.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AA.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AA.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AA.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AA.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AA.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AA.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AA.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AA.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AA.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AA.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AA.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AA.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AA.ArtifactSphereDamage'
