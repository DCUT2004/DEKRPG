...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AC.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AC.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AC.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AC.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AC.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AC.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AC.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AC.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AC.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AC.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AC.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AC.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AC.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AC.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AC.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AC.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AC.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AC.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AC.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AC.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AC.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AC.ArtifactSphereDamage'
