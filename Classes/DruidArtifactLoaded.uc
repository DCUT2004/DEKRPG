...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG209C.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG209C.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG209C.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG209C.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG209C.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG209C.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG209C.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG209C.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG209C.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG209C.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG209C.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG209C.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG209C.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG209C.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG209C.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG209C.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG209C.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG209C.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG209C.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG209C.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG209C.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG209C.ArtifactSphereDamage'
