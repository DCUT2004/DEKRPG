...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AJ.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AJ.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AJ.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AJ.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AJ.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AJ.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AJ.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AJ.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AJ.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AJ.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AJ.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AJ.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AJ.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AJ.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AJ.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AJ.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AJ.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AJ.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AJ.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AJ.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AJ.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AJ.ArtifactSphereDamage'
