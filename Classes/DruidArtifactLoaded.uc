...
defaultproperties
{
     Level1Artifact(0)=Class'DEKRPG208AG.DruidArtifactFlight'
     Level1Artifact(1)=Class'DEKRPG208AG.DruidArtifactTeleport'
     Level1Artifact(2)=Class'DEKRPG208AG.DruidArtifactSpider'
     Level1Artifact(3)=Class'DEKRPG208AG.DruidArtifactMakeMagicWeapon'
     Level1Artifact(4)=Class'UT2004RPG.ArtifactInvulnerability'
     Level1Artifact(5)=Class'DEKRPG208AG.ArtifactPlusAddon'
     Level2Artifact(0)=Class'DEKRPG208AG.DruidArtifactTripleDamage'
     Level2Artifact(1)=Class'DEKRPG208AG.DruidMaxModifier'
     Level2Artifact(2)=Class'DEKRPG208AG.ArtifactFireBall'
     Level2Artifact(3)=Class'DEKRPG208AG.ArtifactRemoteDamage'
     Level2Artifact(4)=Class'DEKRPG208AG.ArtifactRemoteInvulnerability'
     Level2Artifact(5)=Class'DEKRPG208AG.ArtifactRemoteMax'
     Level3Artifact(0)=Class'DEKRPG208AG.DruidArtifactLightningRod'
     Level3Artifact(1)=Class'DEKRPG208AG.DruidDoubleModifier'
     Level3Artifact(2)=Class'DEKRPG208AG.DruidPlusOneModifier'
     Level3Artifact(3)=Class'DEKRPG208AG.ArtifactMegaBlast'
     Level3Artifact(4)=Class'DEKRPG208AG.ArtifactPoisonBlast'
     Level4Artifact(0)=Class'DEKRPG208AG.ArtifactLightningBolt'
     Level4Artifact(1)=Class'DEKRPG208AG.ArtifactLightningBeam'
     Level4Artifact(2)=Class'DEKRPG208AG.ArtifactChainLightning'
     Level4Artifact(3)=Class'DEKRPG208AG.ArtifactRepulsion'
     Level4Artifact(4)=Class'DEKRPG208AG.ArtifactSphereInvulnerability'
     Level4Artifact(5)=Class'DEKRPG208AG.ArtifactSphereDamage'
