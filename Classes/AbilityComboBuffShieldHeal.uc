...
defaultproperties
{
	...
	Description="Caster and all allies receive 40 shield per level. Healing over the max shield is added as temporary max shield.||Non-AMs can only have one type of Ailment at a time, AMs can have two.||REQUIRED MATERIALS (for non-AMs):|You need 5 times the ability level of Lumber and Steel you wish to purchase. Additionally:||Level 5: 10 Fine Leather, 10 Plated Armor||Level 6: 20 Fine Leather, 20 Plated Armor||Level 7: 30 Fine Leather, 30 Plated Armor||Level 8: 40 Fine Leather, 40 Plated Armor, 10 Nanite Fragment||Level 9: 45 Fine Leather, 45 Plated Armor, 25 Nanite Fragment||Level 10: 50 Fine Leather, 50 Plated Armor, 50 Nanite Fragment||Cost(per level): 3, 6, 9...||NOTE: Use the combo BBFF(back back forward forward) with 100 adrenaline to activate this combo."
