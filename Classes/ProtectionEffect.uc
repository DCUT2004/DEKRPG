class ProtectionEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         UseColorScale=True
         UniformSize=True
         ColorScale(0)=(Color=(R=247,G=243,B=110))
         ColorScale(1)=(RelativeTime=1.000000,Color=(R=247,G=243,B=110))
         Opacity=0.100000
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKRPG208AJ.ProtectionEffect.SpriteEmitter0'

     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         UseColorScale=True
         UniformSize=True
         ColorScale(0)=(Color=(R=247,G=243,B=110))
         ColorScale(1)=(RelativeTime=1.000000,Color=(R=247,G=243,B=110,A=255))
         ...
         LifetimeRange=(Min=0.100000,Max=0.100000)
     End Object
     Emitters(1)=SpriteEmitter'DEKRPG208AJ.ProtectionEffect.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         LifetimeRange=(Min=0.100000,Max=0.100000)
     End Object
     Emitters(2)=SpriteEmitter'DEKRPG208AJ.ProtectionEffect.SpriteEmitter3'
     ...
     End Object
     Emitters(3)=SpriteEmitter'DEKRPG208AJ.ProtectionEffect.SpriteEmitter4'
