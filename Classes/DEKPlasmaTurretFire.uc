...
defaultproperties
{
     TeamProjectileClasses(0)=Class'DEKRPG209C.DEKPlasmaTurretProj'
     TeamProjectileClasses(1)=Class'DEKRPG209C.DEKPlasmaTurretProj'
     FireSound=Sound'DEKRPG209C.TurretSounds.PlasmaTurretFire'
     FireRate=0.300000
}
