...
defaultproperties
{
	...
	Description="The caster and all allies receive 2.5% damage reduction per level for 25 seconds. If a similar buff is applied, the effect is stacked. Allies with increased defense have a green orb.||Non-AMs can only have one type of Ailment at a time, AMs can have two.||REQUIRED MATERIALS (for non-AMs):|You need 5 times the ability level of Combat Boots and Steel you wish to purchase. Additionally:||Level 5: 10 Fine Plated Armor, 10 Arctic Suit||Level 6: 20 Fine Plated Armor, 20 Arctic Suit||Level 7: 30 Fine Plated Armor, 30 Arctic Suit||Level 8: 40 Fine Plated Armor, 40 Arctic Suit, 10 Icicles||Level 9: 45 Fine Plated Armor, 45 Arctic Suit, 25 Icicles||Level 10: 50 Fine Plated Armor, 50 Arctic Suit, 50 Icicles||Cost(per level): 5, 10, 15, 20...||NOTE: Use the combo BBFF(back back forward forward) with 100 adrenaline to activate this combo."
	MaxLevel=10
	StartingCost=5
	CostAddPerLevel=5
