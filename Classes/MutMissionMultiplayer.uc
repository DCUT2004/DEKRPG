...
simulated function Timer()
{
	...
	if(!stopped)
	{
		...
		if (Countdown == 0)
		{
			...
			for ( C = Level.ControllerList; C != None; C = C.NextController )
				if (C != None && C.Pawn != None && C.Pawn.Health > 0 && C.IsA('PlayerController'))
					PlayerController(C).ClientPlaySound(Sound'DEKRPG208AC.MissionSounds.MP3VoiceStart');
		...
		else if (MissionClock >= TimeLimit && MissionClock != 0)		//When the time limit to complete the mission has been reached
		{
			...
			for ( C = Level.ControllerList; C != None; C = C.NextController )
				if (C != None && C.Pawn != None && C.Pawn.Health > 0 && C.IsA('PlayerController') )
					PlayerController(C).ClientPlaySound(Sound'DEKRPG208AC.MissionSounds.MP3VoiceTimeUp');
			...
			if (P != None)
			{
				...
				if (!GenomeProjectActive)
				{
					if (PlayerController(C) != None)
						PlayerController(C).ClientPlaySound(Sound'DEKRPG208AC.MissionSounds.MP3VoiceFinish');
				}
			}
		}
		//Add material
...
defaultproperties
{
	...
	CountDown=10
	BalloonClass(0)=Class'DEKRPG208AC.MissionBalloon'
	BalloonClass(1)=Class'DEKRPG208AC.MissionBalloonBlue'
	BalloonClass(2)=Class'DEKRPG208AC.MissionBalloonGreen'
	BalloonClass(3)=Class'DEKRPG208AC.MissionBalloonOrange'
	BalloonClass(4)=Class'DEKRPG208AC.MissionBalloonYellow'
	BalloonClass(5)=Class'DEKRPG208AC.MissionBalloonPurple'
	GenomeXPPerVial=5
	NumMaxVials=2
	VialPickupClass(0)=Class'DEKRPG208AC.GenomeVialCosmicPickup'
	VialPickupClass(1)=Class'DEKRPG208AC.GenomeVialFirePickup'
	VialPickupClass(2)=Class'DEKRPG208AC.GenomeVialIcePickup'
	VialPickupClass(3)=Class'DEKRPG208AC.GenomeVialGhostPickup'
	VialPickupClass(4)=Class'DEKRPG208AC.GenomeVialTechPickup'
	MusicalWeaponsList(0)=Class'DEKWeapons208AC.INAVRiL'
	...
	PortalBallClass(0)=Class'DEKRPG208AC.MissionPortalBallBlue'
	PortalBallClass(1)=Class'DEKRPG208AC.MissionPortalBallGreen'
	PortalBallClass(2)=Class'DEKRPG208AC.MissionPortalBallOrange'
	PortalBallClass(3)=Class'DEKRPG208AC.MissionPortalBallPink'
	PortalBallClass(4)=Class'DEKRPG208AC.MissionPortalBallPurple'
	PortalBallClass(5)=Class'DEKRPG208AC.MissionPortalBallRed'
	MaterialChance=5
	LowMaterialChance=80
	MediumMaterialChance=95
	LowMaterial(0)=Class'DEKRPG208AC.AbilityMaterialLumber'
	LowMaterial(1)=Class'DEKRPG208AC.AbilityMaterialCombatBoots'
	LowMaterial(2)=Class'DEKRPG208AC.AbilityMaterialTarydiumShards'
	LowMaterial(3)=Class'DEKRPG208AC.AbilityMaterialSteel'
	LowMaterial(4)=Class'DEKRPG208AC.AbilityMaterialNaliFruit'
	LowMaterial(5)=Class'DEKRPG208AC.AbilityMaterialGloves'
	MediumMaterial(0)=Class'DEKRPG208AC.AbilityMaterialLeather'
	MediumMaterial(1)=Class'DEKRPG208AC.AbilityMaterialPlatedArmor'
	MediumMaterial(2)=Class'DEKRPG208AC.AbilityMaterialHoneysuckleVine'
	MediumMaterial(3)=Class'DEKRPG208AC.AbilityMaterialEmbers'
	MediumMaterial(4)=Class'DEKRPG208AC.AbilityMaterialArcticSuit'
	HighMaterial(0)=Class'DEKRPG208AC.AbilityMaterialMoss'
	HighMaterial(1)=Class'DEKRPG208AC.AbilityMaterialDust'
	HighMaterial(2)=Class'DEKRPG208AC.AbilityMaterialNanite'
	HighMaterial(3)=Class'DEKRPG208AC.AbilityMaterialPumice'
	HighMaterial(4)=Class'DEKRPG208AC.AbilityMaterialIcicle'
	NumMaxBalls=2
