...
static simulated function ModifyMonster(Monster Other, int AbilityLevel)
{
	...
	DEKFriendlyMonsterController(Other.Controller).InitializeSkill(AbilityLevel); //start it out here. It will probably be re-initialized in a moment, but it's better to start it here.
}

defaultproperties
{
     AbilityName="Pets: Intelligence"
