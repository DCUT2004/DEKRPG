...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG208AC.TurretSounds.PlasmaTurretAltFire',,150.000);
...
defaultproperties
{
     TeamProjectileClasses(0)=Class'DEKRPG208AC.PROJ_DruidBallTurretBall'
     TeamProjectileClasses(1)=Class'DEKRPG208AC.PROJ_DruidBallTurretBall'
     FireSound=None
     FireRate=1.500000
}
