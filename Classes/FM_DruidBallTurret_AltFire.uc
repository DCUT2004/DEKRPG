...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG209E.TurretSounds.PlasmaTurretAltFire',,150.000);
...
defaultproperties
{
     TeamProjectileClasses(0)=Class'DEKRPG209E.PROJ_DruidBallTurretBall'
     TeamProjectileClasses(1)=Class'DEKRPG209E.PROJ_DruidBallTurretBall'
     FireSound=None
     FireRate=1.500000
}
