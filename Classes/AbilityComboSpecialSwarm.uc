...
defaultproperties
{
	...
	All=True
	Single=False
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(5))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(10))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(15))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(20))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(25))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(30))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(35))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(40))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(45))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialHourglass'),RequiredMaterialLevels=(50))
}