...
defaultproperties
{
    ...
    ExcludingAbilities(1)=Class'DEKRPG209E.AbilityComboSpecialTeleStealth'
	...
	All=True
	Single=False
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(5))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(10))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(15))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(20))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(25))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(30))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(35))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(40))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(45))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209E.AbilityMaterialHourglass'),RequiredMaterialLevels=(50))
}