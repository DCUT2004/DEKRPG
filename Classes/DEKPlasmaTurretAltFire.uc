...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG209C.TurretSounds.PlasmaTurretAltFire',,200.000);
...
defaultproperties
{
     TeamProjectileClasses(0)=Class'DEKRPG209C.DEKPlasmaTurretBallProj'
     TeamProjectileClasses(1)=Class'DEKRPG209C.DEKPlasmaTurretBallProj'
     FireSound=None
     FireRate=1.500000
}
