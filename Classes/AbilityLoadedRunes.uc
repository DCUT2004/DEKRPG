...
defaultproperties
{
     ...
     PlayerLevelReqd(4)=1
     PlayerLevelReqd(5)=1
     Weapons(0)="DEKRPG209F.RuneFireball_Heatwave"
     Weapons(1)="DEKRPG209F.RuneLaser_Guard"
     Weapons(2)="DEKRPG209F.RuneFlurry_Magnet"
     Weapons(3)="DEKRPG209F.RuneSparkle_Barrage"
     Weapons(4)="DEKRPG209F.RuneEnergySteal"
     ONSWeapons(0)="DEKRPG209F.RuneBeam_Chain"
     ONSWeapons(1)="DEKRPG209F.RuneHeatWhip_Flare"
     ONSWeapons(3)="DEKRPG209F.RuneEarthquake_Blizzard"
     SuperWeapons(0)="DEKRPG209F.RuneMegaBlast_PoisonBlast"
