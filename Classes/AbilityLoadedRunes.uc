...
defaultproperties
{
     ...
     PlayerLevelReqd(4)=1
     PlayerLevelReqd(5)=1
     Weapons(0)="DEKRPG209E.RuneFireball_Heatwave"
     Weapons(1)="DEKRPG209E.RuneLaser_Guard"
     Weapons(2)="DEKRPG209E.RuneImmobilize_Magnet"
     Weapons(3)="DEKRPG209E.RuneFlurry_Barrage"
     Weapons(4)="DEKRPG209E.RuneEnergySteal"
     ONSWeapons(0)="DEKRPG209E.RuneBeam_Chain"
     ONSWeapons(1)="DEKRPG209E.RuneHeatWhip_Flare"
     ONSWeapons(3)="DEKRPG209E.RuneEarthquake_Blizzard"
     SuperWeapons(0)="DEKRPG209E.RuneMegaBlast_PoisonBlast"
