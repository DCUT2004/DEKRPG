...
#exec  AUDIO IMPORT NAME="SphereActivate" FILE="Sounds\SphereActivate.WAV" GROUP="ArtifactSounds"
#exec  AUDIO IMPORT NAME="SphereDeactivate" FILE="Sounds\SphereDeactivate.WAV" GROUP="ArtifactSounds"
...
state Activated
{
	...
	{	local Vehicle V;
		...
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			SetTimer(0.5, true);
			Instigator.PlaySound(Sound'DEKRPG999X.ArtifactSounds.SphereActivate',,200.00);
		}
	}
	function Timer()
	{
	...
	function EndState()
	{
		...
		if (Instigator != None)
		{
			Instigator.DisableUDamage();
			Instigator.SetOverlayMaterial(EffectOverlay, -1, true);
			Instigator.PlaySound(Sound'DEKRPG999X.ArtifactSounds.SphereDeactivate',,200.00);
		}
		bActive = false;
...
defaultproperties
{
     ...
     CostPerSec=15
     PickupClass=Class'DEKRPG999X.ArtifactSphereDamagePickup'
     IconMaterial=Texture'DEKRPGTexturesMaster209B.Artifacts.SphereDamage'
