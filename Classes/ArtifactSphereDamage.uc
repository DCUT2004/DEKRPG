...
state Activated
{
	...
	{	local Vehicle V;
		...
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			SetTimer(0.5, true);
			Instigator.PlaySound(Sound'DEKRPG209C.ArtifactSounds.SphereActivate',,200.00);
		}
	}
	function Timer()
	{
	...
	function EndState()
	{
		...
		if (Instigator != None)
		{
			Instigator.DisableUDamage();
			Instigator.SetOverlayMaterial(EffectOverlay, -1, true);
			Instigator.PlaySound(Sound'DEKRPG209C.ArtifactSounds.SphereDeactivate',,200.00);
		}
		bActive = false;
...
defaultproperties
{
     ...
     CostPerSec=15
     PickupClass=Class'DEKRPG209C.ArtifactSphereDamagePickup'
