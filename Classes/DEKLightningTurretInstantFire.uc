...
simulated function DoTrace(Vector Start, Rotator Dir)
{
    ...
    tmpHitEmitClass = class'DEKRPG209B.DEKLightningTurretLightningBeamFX';
...
defaultproperties
{
     ...
     DamageTypeHeadShot=Class'DEKRPG209B.DamTypeLightningTurretHeadShot'
     DamageType=Class'DEKRPG209B.DamTypeLightningTurretLightningBeam'
     DamageMin=55
     DamageMax=55
     FireSound=None
     FireRate=1.000000
