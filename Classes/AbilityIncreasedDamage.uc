...
defaultproperties
{
     DamageMultiplier=0.187500
     SpeedMultiplier=0.050000
     AbilityName="Increased Damage Bonus"
     Description="Increases your cumulative total damage bonus by 18.75% per level. However, weapon speed is reduced by 5% per level.|Cost (per level): 10."
     StartingCost=10
     MaxLevel=20
}
