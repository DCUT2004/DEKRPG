class MTMissle extends Projectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	PlaySound(sound'WeaponSounds.BExplosion3',, 3.5*TransientSoundVolume);
    ...
    {
    	Spawn(class'MTMissileExplosion',,,HitLocation + HitNormal*16,rotator(HitNormal));
...
defaultproperties
{
     ...
     MyDamageType=Class'MTII.DamTypeMTIIMissle'
