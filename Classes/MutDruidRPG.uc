...
defaultproperties
{
     ...
     ArtifactKeyConfigs(29)=(Alias="SelectHeavyGuard",ArtifactClass=Class'DEKRPG999X.ArtifactMakeHeavyGuard')
     ArtifactKeyConfigs(30)=(Alias="SelectGorgon",ArtifactClass=Class'DEKRPG999X.ArtifactMakeGorgon')
     ArtifactKeyConfigs(31)=(Alias="SelectInfinity",ArtifactClass=Class'DEKRPG999X.ArtifactMakeInfinity')
     ArtifactKeyConfigs(32)=(Alias="SelectLucky",ArtifactClass=Class'DEKRPG999X.ArtifactMakeLucky')
     ArtifactKeyConfigs(33)=(Alias="SelectMagnet",ArtifactClass=Class'DEKRPG999X.ArtifactPriestMagnet')
     ArtifactKeyConfigs(34)=(Alias="SelectMatrix",ArtifactClass=Class'DEKRPG999X.ArtifactMakeMatrix')
     ArtifactKeyConfigs(35)=(Alias="SelectDecoy",ArtifactClass=Class'DEKRPG999X.ArtifactDecoy')
     ArtifactKeyConfigs(36)=(Alias="SelectImmobilize",ArtifactClass=Class'DEKRPG999X.ArtifactImmobilize')
     ArtifactKeyConfigs(37)=(Alias="SelectGlowStreak",ArtifactClass=Class'DEKRPG999X.ArtifactGlowStreak')
     ArtifactKeyConfigs(38)=(Alias="SelectMeteor",ArtifactClass=Class'DEKRPG999X.ArtifactMeteorShower')
     ArtifactKeyConfigs(39)=(Alias="SelectRemoteAmplifier",ArtifactClass=Class'DEKRPG999X.ArtifactRemoteAmplifier')
     GroupName="DruidsRPG"
