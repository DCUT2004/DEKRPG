...
defaultproperties
{
	...
	All=False
	Single=True
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(5))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(10))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(15))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(20))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(25))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(30))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(35))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(40))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(45))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTranslator'),RequiredMaterialLevels=(50))
}