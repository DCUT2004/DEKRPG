...
defaultproperties
{
     ...
     Description="For each level of this ability, you gain health from all kills. You must have at least 50 Damage Bonus and at least 150 Health Bonus to purchase this ability. |Cost (per level): 5,6,7..."
     StartingCost=5
     CostAddPerLevel=1
     MaxLevel=20
}
