...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKRPG208AG.DEKLaserGrenadeFire'
     FireModeClass(1)=Class'DEKRPG208AG.DEKLaserGrenadeAltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=3
     GroupOffset=1
     PickupClass=Class'DEKRPG208AG.DEKLaserGrenadePickup'
