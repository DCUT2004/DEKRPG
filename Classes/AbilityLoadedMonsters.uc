...
defaultproperties
{
     ...
     ExtremeLevel=11
     ExcludingAbilities(0)=Class'DEKRPG999X.AbilityNicheSummonerLoadedFireMonsters'
     ExcludingAbilities(1)=Class'DEKRPG999X.AbilityNicheSummonerLoadedIceMonsters'
