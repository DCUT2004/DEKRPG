...
function int NetDamage(int OriginalDamage, int Damage, pawn injured, pawn instigatedBy, vector HitLocation, out vector Momentum, class<DamageType> DamageType)
{
	...
	else if (Monster(injured) != None && DEKFriendlyMonsterController(injured.Controller) == None && Monster(instigatedBy) != None && DEKFriendlyMonsterController(instigatedBy.Controller) == None)
	{
	...
	if (InstigatedData == None || InjuredData == None)
	{
		if (Level.Game.IsA('Invasion'))
		{
			...
			MonsterLevel = 1;
		if ( InstigatedData == None && ( (instigatedBy.IsA('Monster') && !instigatedBy.Controller.IsA('DEKFriendlyMonsterController'))
		...
		if ( InjuredData == None && InstigatedData != None && ( (injured.IsA('Monster') && !injured.Controller.IsA('DEKFriendlyMonsterController'))
