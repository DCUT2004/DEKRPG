...
simulated function PlayMonsterComboSound()
{
	...
	for ( C = Level.ControllerList; C != None; C = C.NextController )
		if (C != None && C.IsA('PlayerController'))
			PlayerController(C).ClientPlaySound(Sound'DEKRPG208AD.MonsterComboSound');
}
...
defaultproperties
{
     ...
     ComboClass(0)=Class'DEKRPG208AD.ComboAttackInv'
     ComboClass(1)=Class'DEKRPG208AD.ComboAttackInv'
     ComboClass(2)=Class'DEKRPG208AD.ComboDefenseInv'
     ComboClass(3)=Class'DEKRPG208AD.ComboDefenseInv'
     ComboClass(4)=Class'DEKRPG208AD.ComboFreezeInv'
     ComboClass(5)=Class'DEKRPG208AD.ComboHeatInv'
     ComboClass(6)=Class'DEKRPG208AD.ComboRegenerateInv'
     ComboClass(7)=Class'DEKRPG208AD.ComboHealStopInv'
     ComboClass(8)=Class'DEKRPG208AD.ComboHealthMaxInv'
     ComboClass(9)=Class'DEKRPG208AD.ComboInaccuracyInv'
     ComboClass(10)=Class'DEKRPG208AD.ComboMisfortuneInv'
