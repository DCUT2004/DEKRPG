...
simulated function PlayMonsterComboSound()
{
	...
	for ( C = Level.ControllerList; C != None; C = C.NextController )
		if (C != None && C.IsA('PlayerController'))
			PlayerController(C).ClientPlaySound(Sound'DEKRPG208AC.MonsterComboSound');
}
...
defaultproperties
{
     ...
     ComboClass(0)=Class'DEKRPG208AC.ComboAttackInv'
     ComboClass(1)=Class'DEKRPG208AC.ComboAttackInv'
     ComboClass(2)=Class'DEKRPG208AC.ComboDefenseInv'
     ComboClass(3)=Class'DEKRPG208AC.ComboDefenseInv'
     ComboClass(4)=Class'DEKRPG208AC.ComboFreezeInv'
     ComboClass(5)=Class'DEKRPG208AC.ComboHeatInv'
     ComboClass(6)=Class'DEKRPG208AC.ComboRegenerateInv'
     ComboClass(7)=Class'DEKRPG208AC.ComboHealStopInv'
     ComboClass(8)=Class'DEKRPG208AC.ComboHealthMaxInv'
     ComboClass(9)=Class'DEKRPG208AC.ComboInaccuracyInv'
     ComboClass(10)=Class'DEKRPG208AC.ComboMisfortuneInv'
