class ArtifactMakePoisonInfinity extends DruidArtifactMakeMagicWeapon;
...
defaultproperties
{
     IconMaterial=Texture'XGameShaders.PlayerShaders.LinkGunShell'
     ItemName="Poisoned Infinity Maker"
}
