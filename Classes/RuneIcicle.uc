...
function DoSound()
{
	PlaySound(Sound'DEKRPG209D.RuneSounds.IcicleGrowth', SLOT_None, 3 * TransientSoundVolume);
}
...
function Shatter()
{
	...
	PlaySound(Sound'DEKRPG209D.RuneSounds.IcicleShatter', SLOT_None, 3 * TransientSoundVolume);
	Destroy();
}
