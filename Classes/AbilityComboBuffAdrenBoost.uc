...
defaultproperties
{
    ExcludingAbilities(0)=Class'DEKRPG209C.AbilityComboBuffWard'
	...
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit'),RequiredMaterialLevels=(25,25,10,10))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit'),RequiredMaterialLevels=(30,30,20,20))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit'),RequiredMaterialLevels=(35,35,30,30))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit',Class'DEKRPG209C.AbilityMaterialMoss'),RequiredMaterialLevels=(40,40,40,40,10))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit',Class'DEKRPG209C.AbilityMaterialMoss'),RequiredMaterialLevels=(45,45,45,45,25))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialPlatedArmor',Class'DEKRPG209C.AbilityMaterialArcticSuit',Class'DEKRPG209C.AbilityMaterialMoss'),RequiredMaterialLevels=(50,50,50,50,50))
}