...
function DoPowerEffect(out int Damage, Actor Victim, Vector HitLocation, out Vector Momentum, class<DamageType> DamageType)
{
	...
	if (P != None && TheWeapon.static.NullCanTriggerPhysics(P))
	{
		...
		if (MInv == None)
		{
			...
			if (StatusInv.AddStatusEffect(Class'StatusEffect_Burn', -LocalModifier*PerformanceIncrease, True, HeatLifespan*PerformanceIncrease, True, False, TheWeapon.Instigator))
			{
