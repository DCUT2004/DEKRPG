...
defaultproperties
{
	...
	All=False
	Single=False
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots'),RequiredMaterialLevels=(2,2,2))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots'),RequiredMaterialLevels=(6,6,6))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots'),RequiredMaterialLevels=(10,10,10))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine'),RequiredMaterialLevels=(15,15,15,5))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine'),RequiredMaterialLevels=(20,20,20,5))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209B.AbilityMaterialSteel',Class'DEKRPG209B.AbilityMaterialNaliFruit',Class'DEKRPG209B.AbilityMaterialCombatBoots',Class'DEKRPG209B.AbilityMaterialHoneysuckleVine',Class'DEKRPG209B.AbilityMaterialEmbers'),RequiredMaterialLevels=(25,25,25,5,5))
