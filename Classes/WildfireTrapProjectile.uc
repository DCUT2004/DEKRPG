...
function BoomSound()
{
	self.PlaySound(sound'DEKRPG208AB.TurretSounds.SolarTurretAltFire',,500.00);
}
...
defaultproperties
{
     ...
     MyDamageType=Class'DEKRPG208AB.DamTypeWildfireTrap'
     ImpactSound=Sound'MenuSounds.select3'
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'DEKStaticsMaster208K.Meshes.WildfireTrap'
