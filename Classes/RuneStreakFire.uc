...
defaultproperties
{
     ...
     FireRate=1.000000
     //ProjectileClass=Class'DEKRPG209C.RuneStreakProj'
	 Projectiles(0)=Class'DEKRPG209C.RuneStreakProjBlue'
	 Projectiles(1)=Class'DEKRPG209C.RuneStreakProjRed'
	 Projectiles(2)=Class'DEKRPG209C.RuneStreakProjGreen'
}
