...
defaultproperties
{
     ...
     FireRate=1.000000
     //ProjectileClass=Class'DEKRPG999X.RuneStreakProj'
	 Projectiles(0)=Class'DEKRPG999X.RuneStreakProjBlue'
	 Projectiles(1)=Class'DEKRPG999X.RuneStreakProjRed'
	 Projectiles(2)=Class'DEKRPG999X.RuneStreakProjGreen'
}
