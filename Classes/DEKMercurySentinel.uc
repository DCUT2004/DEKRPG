...
defaultproperties
{
     ...
     TurretBaseClass=Class'DEKRPG209A.DEKMercurySentinelFloorBase'
     TurretSwivelClass=Class'DEKRPG209A.DEKMercurySentinelFloorSwivel'
     ...
     Skins(2)=Combiner'DEKRPGTexturesMaster209A.Skins.MercFloorTurret'
}
