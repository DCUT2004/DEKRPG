...
defaultproperties
{
     FireModeClass(0)=Class'DEKRPG209F.DEKPlasmaTurretFire'
     FireModeClass(1)=Class'DEKRPG209F.DEKPlasmaTurretAltFire'
     AttachmentClass=Class'DEKRPG209F.DEKPlasmaTurretAttachment'
}
