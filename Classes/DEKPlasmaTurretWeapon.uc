...
defaultproperties
{
     FireModeClass(0)=Class'DEKRPG209C.DEKPlasmaTurretFire'
     FireModeClass(1)=Class'DEKRPG209C.DEKPlasmaTurretAltFire'
     AttachmentClass=Class'DEKRPG209C.DEKPlasmaTurretAttachment'
}
