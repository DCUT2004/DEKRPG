	...
	if(Damage > 0)
	{
		if (ClassIsChildOf(DamageType, class'WeaponDamageType'))
		{
			if (Instigator.Controller != None && 
				(DruidSentinelController(Instigator.Controller) != None || DruidBaseSentinelController(Instigator.Controller) != None || DruidLightningSentinelController(Instigator.Controller) != None || DruidEnergyWallController(Instigator.Controller) != None || DEKMercuryController(Instigator.Controller) != None || DEKBeamSentinelController(Instigator.Controller) != None || DEKAutoMachinegunController(Instigator.Controller) != None || DEKAutoSniperController(Instigator.Controller) != None || DEKHellfireSentinelController(Instigator.Controller) != None || DEKMachineGunSentinelController(Instigator.Controller) != None || AASentinelController(Instigator.Controller) != None || DEKSniperSentinelController(Instigator.Controller) != None || DEKRocketSentinelController(Instigator.Controller) != None ))
			{
...
defaultproperties
{
     ...
     Level4MaxPoints=28
     Level5MaxPoints=30
     ExcludingAbilities(0)=Class'DEKRPG999X.AbilityLinkUpBuilder'
