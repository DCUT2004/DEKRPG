...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG209A.TurretSounds.StingerAltFire',,0.500);
	return none;
}
...
defaultproperties
{
     ...
     ProjectileClass=Class'DEKRPG209A.DEKStingerTurretAltProj'
     BotRefireRate=0.700000
     FlashEmitterClass=Class'DEKRPG209A.DEKStingerTurretMuzFX'
}
