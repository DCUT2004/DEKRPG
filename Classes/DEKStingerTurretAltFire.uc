...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG208AF.TurretSounds.StingerAltFire',,0.500);
	return none;
}
...
defaultproperties
{
     ...
     ProjectileClass=Class'DEKRPG208AF.DEKStingerTurretAltProj'
     BotRefireRate=0.700000
     FlashEmitterClass=Class'DEKRPG208AF.DEKStingerTurretMuzFX'
}
