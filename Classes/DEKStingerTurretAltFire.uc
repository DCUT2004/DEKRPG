...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	Instigator.PlaySound(Sound'DEKRPG208AD.TurretSounds.StingerAltFire',,0.500);
	return none;
}
...
defaultproperties
{
     ...
     ProjectileClass=Class'DEKRPG208AD.DEKStingerTurretAltProj'
     BotRefireRate=0.700000
     FlashEmitterClass=Class'DEKRPG208AD.DEKStingerTurretMuzFX'
}
