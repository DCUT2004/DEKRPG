class FlowerHealFX extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255))
         FadeOutStartTime=1.300000
         FadeInEndTime=0.250000
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=600.000000,Max=600.000000)
         ...
         StartSizeRange=(X=(Min=8.000000,Max=8.000000),Y=(Min=48000000.000000,Max=8.000000),Z=(Min=16.000000,Max=16.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKRPG208AG.FlowerHealFX.SpriteEmitter2'
