...
defaultproperties
{
    ExcludingAbilities(0)=Class'DEKRPG209D.AbilityComboSpecialSwarm'
	...
	All=True
	Single=False
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(5))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(10))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(15))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(20))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(25))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(30))
	Materials(6)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(35))
	Materials(7)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(40))
	Materials(8)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(45))
	Materials(9)=(RequiredMaterials=(Class'DEKRPG209D.AbilityMaterialStarChart'),RequiredMaterialLevels=(50))
}