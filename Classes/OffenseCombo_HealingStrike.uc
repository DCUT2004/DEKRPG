class OffenseCombo_HealingStrike extends OffenseCombo
	config(UT2004RPG);
	
var config float HealthDamagePercent;
...
function DoDamage(Pawn Target)
{
	...
	if (Instigator != None)
		Instigator.GiveHealth(DamagePerHit*HealthDamagePercent, Instigator.HealthMax);
}

defaultproperties
{
	HealthDamagePercent=0.0200000
}
