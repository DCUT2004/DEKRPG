class AbilityMaterialGloves extends AbilityMaterialLowRarity
	config(UT2004RPG)
	abstract;
...
defaultproperties
{
     ...
     AbilityName="Gloves*"
     Description="Gloves to protect the hand. Increases your max shield by 0.1% per level.||Rarity: Low*||This material can be found by making kills, completing solo and team missions, using Loot magic modifier, winning the game, or defeating bosses.||You must be level 60 to purchase this.||Cost (per level): 3"
	 MaxLevel=50
}
