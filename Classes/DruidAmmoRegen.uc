...
defaultproperties
{
     ...
     Description="Adds 1 ammo per level to each ammo type you own every 3 seconds. Does not give ammo to superweapons or the translocator. You must have a Max Ammo stat of at least 50 to purchase this ability. Cost(per level): 15,20,25,30"
     StartingCost=15
     CostAddPerLevel=5
     MaxLevel=6
}
