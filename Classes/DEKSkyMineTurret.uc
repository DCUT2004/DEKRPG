class DEKSkyMineTurret extends ASTurret_BallTurret;
...
simulated event PostBeginPlay()
{
	...
	NumHealers = 0;
	DefaultWeaponClassName=string(class'DEKSkyMineTurretWeapon');
...
defaultproperties
{
     ...
     DefaultWeaponClassName="DEKSkyMineTurretWeapon"
     ...
     VehicleNameString="Sky Mine Turret"
}
