...
defaultproperties
{
     Invalid(0)=Class'DEKRPG208AF.RW_Rage'
     Invalid(1)=Class'DEKRPG208AF.RW_Vorpal'
     Invalid(2)=Class'DEKRPG208AF.RW_EngineerLink'
     CostPerSec=10
     PickupClass=Class'DEKRPG208AF.DruidArtifactTripleDamagePickup'
}
