...
defaultproperties
{
     Invalid(0)=Class'DEKRPG209A.RW_Rage'
     Invalid(1)=Class'DEKRPG209A.RW_Vorpal'
     Invalid(2)=Class'DEKRPG209A.RW_EngineerLink'
     CostPerSec=10
     PickupClass=Class'DEKRPG209A.DruidArtifactTripleDamagePickup'
}
