...
defaultproperties
{
     Invalid(0)=Class'DEKRPG209F.RW_Rage'
     Invalid(1)=Class'DEKRPG209F.RW_Vorpal'
     Invalid(2)=Class'DEKRPG209F.RW_EngineerLink'
     CostPerSec=10
     PickupClass=Class'DEKRPG209F.DruidArtifactTripleDamagePickup'
}
