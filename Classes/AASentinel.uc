...
simulated event PostBeginPlay()
{
	...
	super(ASVehicle_Sentinel_Floor).PostBeginPlay();
}
...
{
	local AASentinelController C;
	
	C = AASentinelController(self.Controller);
...
defaultproperties
{
     ...
     OpenCloseSound=None
     TurretBaseClass=Class'DEKRPG999X.AutoGunBase'
     TurretSwivelClass=Class'DEKRPG999X.AutoGunSwivel'
