...
defaultproperties
{
	...
	All=True
	Single=False
	Materials(0)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber'),RequiredMaterialLevels=(2,2,2))
	Materials(1)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber'),RequiredMaterialLevels=(6,6,6))
	Materials(2)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber'),RequiredMaterialLevels=(10,10,10))
	Materials(3)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber',Class'DEKRPG209C.AbilityMaterialLeather'),RequiredMaterialLevels=(15,15,15,5))
	Materials(4)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber',Class'DEKRPG209C.AbilityMaterialLeather'),RequiredMaterialLevels=(20,20,20,5))
	Materials(5)=(RequiredMaterials=(Class'DEKRPG209C.AbilityMaterialTarydiumShards',Class'DEKRPG209C.AbilityMaterialNaliFruit',Class'DEKRPG209C.AbilityMaterialLumber',Class'DEKRPG209C.AbilityMaterialLeather',Class'DEKRPG209C.AbilityMaterialPlatedArmor'),RequiredMaterialLevels=(25,25,25,5,5))
