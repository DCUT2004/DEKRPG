/*
* StatusEffectData is an abstract Object that holds a struct representing a StatusEffect
...
var string StatusEffectName;					//Uniquely identifes a status effect
var string FriendlyName;						//For game annoucements
