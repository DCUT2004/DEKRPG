class ArtifactMissionForestHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		...
		if (M1Inv.ForestHuntActive || M2Inv.ForestHuntActive || M3Inv.ForestHuntActive)
		{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208AB.ArtifactMissionForestHuntPickup'
