...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'DEKRPG208AA.DEKLynxRocketPack')
     VehiclePositionString="in a Lynx"
     VehicleNameString="Lynx"
     RanOverDamageType=Class'DEKRPG208AA.DamTypeLynxRoadkill'
     CrushedDamageType=Class'DEKRPG208AA.DamTypeLynxPancake'
