class AbilityComboAilmentAttack extends AbilityComboAilment
	config(UT2004RPG)
	abstract;
...
static function ModifyPawn(Pawn Other, int AbilityLevel)
{
	...
	StatusInv.AddCombo(Class'StatusEffect_DamageBonus'.static.GetName(), -AbilityLevel, default.BaseLifespan, default.Dispellable, default.Stackable);
}

defaultproperties
{
	AbilityName="Ailment: Attack"
	Description="All targets receive -2% damage bonus per level for 25 seconds. If a similar ailment is applied, the effect is stacked. Targets with lowered attack have a red berserk ring.||Non-AMs can only have one type of Ailment at a time, AMs can have two.||REQUIRED MATERIALS (for non-AMs):|You need 5 times the ability level of Nali Fruit and Steel you wish to purchase. Additionally:||Level 5: 10 Fine Leather, 10 Burning Embers||Level 6: 20 Fine Leather, 20 Burning Embers||Level 7: 30 Fine Leather, 30 Burning Embers||Level 8: 40 Fine Leather, 40 Burning Embers, 10 Nanite Fragment||Level 9: 45 Fine Leather, 45 Burning Embers, 25 Nanite Fragment||Level 10: 50 Fine Leather, 50 Burning Embers, 50 Nanite Fragment||Cost(per level): 3, 6, 9...||NOTE: Use the combo BBFF(back back forward forward) with 100 adrenaline to activate this combo."
