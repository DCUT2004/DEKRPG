...
{	
	...
	HitPawn = Pawn(AHit);
	if ( HitPawn != Instigator && HitPawn.Health > 0 && !HitPawn.Controller.SameTeamAs(Instigator.Controller)
	     && VSize(HitPawn.Location - StartTrace) < MaxRange && HitPawn.Controller.bGodMode == False && !HitPawn.IsA('HealerNali') && !HitPawn.IsA('MissionCow'))
	{
...
defaultproperties
{
     HitEmitterClass=Class'DEKRPG208AA.ChainLightningEmitter'
